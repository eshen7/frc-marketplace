...
from .views import user_views, part_views, part_request_views, login_view, logout_view, get_logged_in_user_view, change_password_view, delete_user_view, user_by_team_number_view, request_view, messages_by_user_get_view, message_by_id_get_view, message_post_view, requests_by_user_view
...
urlpatterns = [
    ...
    path("requests/user/<str:team_number>/", requests_by_user_view, name = "part_request_views"),
    ...
    path("message/<str:team_number>/", messages_by_user_get_view, name="messages_by_user_get_view"),
    path("message/id/<str:message_id>/", message_by_id_get_view, name="message_by_id_get_view"),
